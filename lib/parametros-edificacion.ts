...
export const PARAMETROS = {
  ...
  frenteDosAlFrente: propio(8.5, "m", "desde este frente entran dos monoambientes lado a lado: Donado 4432 lo hace en 8,67"),
  pasilloIngreso: propio(1.2, "m", "pasillo lateral de ingreso en PB, pegado a la medianera, de la calle al núcleo"),
